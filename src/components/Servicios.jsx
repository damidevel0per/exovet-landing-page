...
const Servicios = () => {
  return (
    <section className=' bg-yellow-300'>
        <div>
          <h2 className='py-15 flex justify-center text-white text-5xl'>Sobre Nosotros</h2>
        </div>

        <div>
        <div className='bg-white-50 flex justify-around items-center py-20 sm:px-12 sm:py-6 px-4 py-3'>
          <div>
        ...
        <div className='py-20 sm:px-12 sm:py-6 px-10 py-3'>
          <p className='text-3xl text-center'>Además de nuestra especialización en animales exóticos, en ExoVet también brindamos atención integral <br /> a mascotas convencionales <span className='text-yellow-600'>como perros y gatos</span>, garantizando el mismo compromiso, cuidado y <br /> profesionalismo para <span className='text-yellow-600'>todos los miembros de tu familia.</span></p>
        </div>
        <div className='flex justify-center'>
          <img className='w-[500px]' src={PerroGato} alt="Conejo blanco y negro" />
        </div>
        </div>
