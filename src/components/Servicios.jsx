...
const Servicios = () => {
  return (
    ...
    <div>
        <div>
          <h2 className='font-semibold py-15 flex justify-center text-black text-5xl'>Servicios que brindamos</h2>
        </div>
    </div>

    <div class="grid grid-cols-2 divide-x-4 divide-purple-700">
