...
const Servicios = () => {
  return (
    ...
    <div>
        <div>
          <h2 className='py-15 flex justify-center text-black text-5xl'>Servicio que brindamos</h2>
        </div>
    </div>

    <div class="grid grid-cols-2 divide-x-4 divide-yellow-400">
        <div className='flex flex-col items-center'>
            <h2 className=' text-2xl text-center'>Atención en nuestro consultorio</h2>
        ...
        <div className='flex flex-col items-center'>
            <h2 className=' text-2xl text-center'>Clinica y cirugia</h2>
    ...
    <div class="py-20 grid grid-cols-2 divide-x-4 divide-yellow-400">
        <div className='flex flex-col items-center'>
            <h2 className=' text-2xl text-center'>Diagnóstico y estudios</h2>
        ...
        <div className='flex flex-col items-center'>
            <h2 className=' text-2xl text-center'>Atención a domicilio</h2>
